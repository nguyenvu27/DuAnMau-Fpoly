...
public class Thang2Activity extends AppCompatActivity {
    ...
    ListView listView ;
    String[] name = {"Tôi tài giỏi bạn cũng thế", "Hôm nay tôi thất tình",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang2) ;
        CustomListViewThang2 customListViewThang2 = new CustomListViewThang2(this, name, gia, img) ;
        listView.setAdapter(customListViewThang2);
    }
}
