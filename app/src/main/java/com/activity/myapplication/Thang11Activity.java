...
public class Thang11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang11) ;
        CustomListViewThang11 customListViewThang11 = new CustomListViewThang11(this, name, gia, img) ;
        listView.setAdapter(customListViewThang11);
    }
}
