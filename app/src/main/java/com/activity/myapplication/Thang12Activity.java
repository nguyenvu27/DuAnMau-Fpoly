...
public class Thang12Activity extends AppCompatActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thang12);

        listView = findViewById(R.id.lvThang12) ;
        CustomListViewThang12 customListViewThang12 = new CustomListViewThang12(this, name, gia, img) ;
        listView.setAdapter(customListViewThang12);
    }
}
