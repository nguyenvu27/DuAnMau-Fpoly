...
public class Thang9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang9) ;
        CustomListViewThang9 customListViewThang9 = new CustomListViewThang9(this, name, gia, img) ;
        listView.setAdapter(customListViewThang9);
    }
}
