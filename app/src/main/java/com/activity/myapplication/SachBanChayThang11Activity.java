...
public class SachBanChayThang11Activity extends AppCompatActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang11);

        listView = findViewById(R.id.lvSachBanChayThang11) ;
        CustomListViewSachBanChayThang11 customListViewSachBanChayThang11 = new CustomListViewSachBanChayThang11(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang11);
    }
}
