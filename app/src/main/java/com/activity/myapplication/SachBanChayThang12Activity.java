...
public class SachBanChayThang12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang12);

        listView = findViewById(R.id.lvSachBanChayThang12) ;
        CustomListViewSachBanChayThang12 customListViewSachBanChayThang12= new CustomListViewSachBanChayThang12(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang12);
