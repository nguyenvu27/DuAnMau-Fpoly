...
public class Thang6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang6) ;
        CustomListViewThang6 customListViewThang6 = new CustomListViewThang6(this, name, gia, img) ;
        listView.setAdapter(customListViewThang6);
    }
}
