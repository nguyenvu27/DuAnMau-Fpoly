...
public class Thang10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang10) ;
        CustomListViewThang10 customListViewThang10 = new CustomListViewThang10(this, name, gia, img) ;
        listView.setAdapter(customListViewThang10);
    }
}
