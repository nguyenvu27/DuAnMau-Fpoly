...
public class Thang8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang8) ;
        CustomListViewThang8 customListViewThang8 = new CustomListViewThang8(this, name, gia, img) ;
        listView.setAdapter(customListViewThang8);
    }
}
