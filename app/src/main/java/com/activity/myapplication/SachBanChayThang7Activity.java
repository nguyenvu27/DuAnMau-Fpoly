...
public class SachBanChayThang7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang7);

        listView = findViewById(R.id.lvSachBanChayThang7) ;
        CustomListViewSachBanChayThang7 customListViewSachBanChayThang7 = new CustomListViewSachBanChayThang7(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang7);
