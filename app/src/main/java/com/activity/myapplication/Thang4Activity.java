...
public class Thang4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thang4);

        listView = findViewById(R.id.lvThang4) ;
        CustomListViewThang4 customListViewThang4 = new CustomListViewThang4(this, name, gia, img) ;
        listView.setAdapter(customListViewThang4);
    }
}
