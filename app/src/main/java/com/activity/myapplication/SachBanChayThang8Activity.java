...
public class SachBanChayThang8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang8);

        listView = findViewById(R.id.lvSachBanChayThang8) ;
        CustomListViewSachBanChayThang8 customListViewSachBanChayThang8 = new CustomListViewSachBanChayThang8(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang8);
