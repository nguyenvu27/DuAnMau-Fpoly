...
public class Thang5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lvThang5) ;
        CustomListViewThang5 customListViewThang5 = new CustomListViewThang5(this, name, gia, img) ;
        listView.setAdapter(customListViewThang5);
    }
}
