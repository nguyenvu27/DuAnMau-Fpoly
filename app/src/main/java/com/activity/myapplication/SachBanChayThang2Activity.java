...
public class SachBanChayThang2Activity extends AppCompatActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang2);

        listView = findViewById(R.id.lvSachBanChayThang2) ;
        CustomListViewSachBanChayThang2 customListViewSachBanChayThang2 = new CustomListViewSachBanChayThang2(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang2);
    }
}
