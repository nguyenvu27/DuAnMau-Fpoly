...
public class SachBanChayThang6Activity extends AppCompatActivity {
    ListView listView ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang6);

        listView = findViewById(R.id.lvSachBanChayThang6) ;
        CustomListViewSachBanChayThang6 customListViewSachBanChayThang6= new CustomListViewSachBanChayThang6(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang6);
    }
}
