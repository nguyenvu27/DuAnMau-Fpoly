...
public class SachBanChayThang10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang10);

        listView = findViewById(R.id.lvSachBanChayThang10) ;
        CustomListViewSachBanChayThang10 customListViewSachBanChayThang10 = new CustomListViewSachBanChayThang10(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang10);
    }
}
