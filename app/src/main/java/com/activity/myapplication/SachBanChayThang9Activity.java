...
public class SachBanChayThang9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_ban_chay_thang9);

        listView = findViewById(R.id.lvSachBanChayThang9) ;
        CustomListViewSachBanChayThang9 customListViewSachBanChayThang9 = new CustomListViewSachBanChayThang9(this, name, gia, img) ;
        listView.setAdapter(customListViewSachBanChayThang9);
    }
}
